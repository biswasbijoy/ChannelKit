...
export function getCountryNameFromFilename(filename: string): string {
  ...
  return getCountryName(code) ?? filename
}
...
export function getFlagImageUrl(code: string, size: number = 40): string {
  return `https://flagcdn.com/h${size}/${code.toLowerCase()}.png`
}
